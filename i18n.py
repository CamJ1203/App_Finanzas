...
TRANSLATIONS = {
    "en": {
        ...
        "No tienes gastos configurados. Ve a ⚙️ Config para agregar fijos, estimaciones o plazos.": "You have no configured expenses. Go to ⚙️ Settings to add fixed expenses, estimates, or installments.",
        ...
        "Plazos": "Installments",
        "Pagos divididos en varios meses. Cuando terminan, desaparecen del plan del mes.": "Payments split across several months. When they end, they disappear from the monthly plan.",
        "meses": "months",
        "Monto total (€)": "Total amount (€)",
        "Cantidad de meses": "Number of months",
        "Cuota mensual del plazo: **€{amount:.2f}**": "Monthly installment: **€{amount:.2f}**",
        "Editar": "Edit",
        "Borrar": "Delete",
        "Cancelar": "Cancel",
    }
