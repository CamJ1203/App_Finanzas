...
from .db_ingresos import (
    ...
    obtener_ingresos, obtener_ingresos_resumen, obtener_ingresos_por_mes,
...
from .db_gastos import (
    ...
    total_gastos_generales, total_gastos_casa, total_gastos_importantes,
    obtener_gastos_generales_por_mes, obtener_gastos_casa_por_mes, obtener_gastos_importantes_por_mes,
)
